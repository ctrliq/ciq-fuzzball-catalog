...
---
id: "ciq/ml_and_ai/vllm_deepseek_ocr_2"
name: "vLLM DeepSeek-OCR-2"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`deepseek-ai/DeepSeek-OCR-2`](https://recipes.vllm.ai/deepseek-ai/DeepSeek-OCR-2)
...
DeepSeek-OCR-2](https://recipes.vllm.ai/deepseek-ai/DeepSeek-OCR-2): every vLLM
...
Next-generation DeepSeek OCR model with improved document-to-markdown grounding
and optical context compression.
...
```sh
fuzzball workflow catalog start vllm_deepseek_ocr_2
fuzzball workflow catalog start vllm_deepseek_ocr_2 --values Hardware=mi355x
fuzzball workflow catalog start vllm_deepseek_ocr_2 --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `deepseek-ai/DeepSeek-OCR-2` regardless of the
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/deepseek-ai/DeepSeek-OCR-2. Regenerate this
