...
---
id: "ciq/ml_and_ai/vllm_llama_3_1_8b_instruct"
...
Serves
[`meta-llama/Llama-3.1-8B-Instruct`](https://recipes.vllm.ai/meta-llama/Llama-3.1-8B-Instruct)
...
Llama-3.1-8B-Instruct](https://recipes.vllm.ai/meta-llama/Llama-3.1-8B-Instruct):
...
| --- | --- | --- | --- |
| `default` | bf16 | 20 GB | `meta-llama/Llama-3.1-8B-Instruct` |
| `nvfp4` | nvfp4 | 5 GB | `nvidia/Llama-3.1-8B-Instruct-NVFP4` |
| `nvidia_fp8` | fp8 | 10 GB | `nvidia/Llama-3.1-8B-Instruct-FP8` |

## Features

-  **`EnableSpecDecoding`** (default off): EAGLE3 speculative decoding
  (requires vLLM >= 0.9.0)

## Usage

```sh
fuzzball workflow catalog start vllm_llama_3_1_8b_instruct
fuzzball workflow catalog start vllm_llama_3_1_8b_instruct --values Hardware=mi355x,Variant=nvidia_fp8
fuzzball workflow catalog start vllm_llama_3_1_8b_instruct --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `meta-llama/Llama-3.1-8B-Instruct` regardless of
...
Image: `docker://vllm/vllm-openai:v0.6.0`
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/meta-llama/Llama-3.1-8B-Instruct. Regenerate this
