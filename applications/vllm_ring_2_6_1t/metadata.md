...
---
id: "ciq/ml_and_ai/vllm_ring_2_6_1t"
name: "vLLM Ring-2.6-1T"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`inclusionAI/Ring-2.6-1T`](https://recipes.vllm.ai/inclusionAI/Ring-2.6-1T)
...
Ring-2.6-1T](https://recipes.vllm.ai/inclusionAI/Ring-2.6-1T): every vLLM flag,
...
Ring-2.6-1T (BailingMoeV2_5) FP8 thinking model with 1T total / 50B active
params, hybrid linear + MLA attention, 128K context

## Model

- **Checkpoint**: `inclusionAI/Ring-2.6-1T`
...
```sh
fuzzball workflow catalog start vllm_ring_2_6_1t
fuzzball workflow catalog start vllm_ring_2_6_1t --values Hardware=mi355x
fuzzball workflow catalog start vllm_ring_2_6_1t --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `inclusionAI/Ring-2.6-1T` regardless of the
...
vllm serve inclusionAI/Ring-2.6-1T \
  ...
  --served-model-name inclusionAI/Ring-2.6-1T
```
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/inclusionAI/Ring-2.6-1T. Regenerate this application
