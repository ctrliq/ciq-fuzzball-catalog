...
---
id: "ciq/ml_and_ai/vllm_qwen2_5_32b"
...
Serves [`Qwen/Qwen2.5-32B`](https://recipes.vllm.ai/Qwen/Qwen2.5-32B) from an
...
[vLLM recipe for Qwen2.5-32B](https://recipes.vllm.ai/Qwen/Qwen2.5-32B): every
...
Qwen2.5 32B dense base (pretrained) language model for text completion —
verified on TPU v6e (Trillium).

## Model

- **Checkpoint**: `Qwen/Qwen2.5-32B`
- **Architecture**: dense, 32B parameters
- **Active parameters**: 32B
- **Context length**: 131072 tokens
- **Minimum vLLM version**: 0.6.2
...
```sh
fuzzball workflow catalog start vllm_qwen2_5_32b
fuzzball workflow catalog start vllm_qwen2_5_32b --values Hardware=mi355x
fuzzball workflow catalog start vllm_qwen2_5_32b --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `Qwen/Qwen2.5-32B` regardless of the variant
...
vllm serve Qwen/Qwen2.5-32B \
  ...
  --served-model-name Qwen/Qwen2.5-32B
```

Image: `docker://vllm/vllm-openai:v0.6.2`
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/Qwen/Qwen2.5-32B. Regenerate this application with
