...
---
id: "ciq/ml_and_ai/vllm_qwen3guard_gen_8b"
...
Serves
[`Qwen/Qwen3Guard-Gen-8B`](https://recipes.vllm.ai/Qwen/Qwen3Guard-Gen-8B) from
...
Qwen3Guard-Gen-8B](https://recipes.vllm.ai/Qwen/Qwen3Guard-Gen-8B): every vLLM
...
Lightweight text-only guardrail/safety classifier model in the Qwen3Guard
family.

## Model

- **Checkpoint**: `Qwen/Qwen3Guard-Gen-8B`
...
| --- | --- | --- | --- |
| `default` | bf16 | 19 GB | `Qwen/Qwen3Guard-Gen-8B` |
| `small_4b` | bf16 | 10 GB | `Qwen/Qwen3Guard-Gen-4B` |
| `tiny_0_6b` | bf16 | 4 GB | `Qwen/Qwen3Guard-Gen-0.6B` |

## Usage

```sh
fuzzball workflow catalog start vllm_qwen3guard_gen_8b
fuzzball workflow catalog start vllm_qwen3guard_gen_8b --values Hardware=mi355x,Variant=tiny_0_6b
fuzzball workflow catalog start vllm_qwen3guard_gen_8b --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `Qwen/Qwen3Guard-Gen-8B` regardless of the variant
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/Qwen/Qwen3Guard-Gen-8B. Regenerate this application
