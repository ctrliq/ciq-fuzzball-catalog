...
---
id: "ciq/ml_and_ai/vllm_kimi_linear_48b_a3b_instruct"
name: "vLLM Kimi-Linear-48B-A3B-Instruct"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`moonshotai/Kimi-Linear-48B-A3B-Instruct`](https://recipes.vllm.ai/moonshotai/Kimi-Linear-48B-A3B-Instruct)
...
Kimi-Linear-48B-A3B-Instruct](https://recipes.vllm.ai/moonshotai/Kimi-Linear-48B-A3B-Instruct):
...
Kimi-Linear is a 48B-parameter instruction-tuned MoE model (~3B activated) with
a linear-attention variant supporting very long context (1M tokens).

## Model

- **Checkpoint**: `moonshotai/Kimi-Linear-48B-A3B-Instruct`
- **Architecture**: moe, 48B parameters
...
```sh
fuzzball workflow catalog start vllm_kimi_linear_48b_a3b_instruct
fuzzball workflow catalog start vllm_kimi_linear_48b_a3b_instruct --values Hardware=mi355x
fuzzball workflow catalog start vllm_kimi_linear_48b_a3b_instruct --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `moonshotai/Kimi-Linear-48B-A3B-Instruct`
...
vllm serve moonshotai/Kimi-Linear-48B-A3B-Instruct \
  ...
  --served-model-name moonshotai/Kimi-Linear-48B-A3B-Instruct
```
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/moonshotai/Kimi-Linear-48B-A3B-Instruct. Regenerate
