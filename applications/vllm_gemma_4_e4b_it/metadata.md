...
---
id: "ciq/ml_and_ai/vllm_gemma_4_e4b_it"
...
Serves [`google/gemma-4-E4B-it`](https://recipes.vllm.ai/Google/gemma-4-E4B-it)
...
from the [vLLM recipe for Gemma 4 E4B
IT](https://recipes.vllm.ai/Google/gemma-4-E4B-it): every vLLM flag,
...
Google's compact Gemma 4 multimodal model (effective 4B) with native text,
...
| --- | --- | --- | --- |
| `default` | bf16 | 20 GB | `google/gemma-4-E4B-it` |
| `fp8` | fp8 | 10 GB | `RedHatAI/gemma-4-E4B-it-FP8-dynamic` |
| `mobile` | int2/4/8 | 5 GB | `google/gemma-4-E4B-it-qat-mobile-ct` |
| `w4a16` | int4 | 10 GB | `google/gemma-4-E4B-it-qat-w4a16-ct` |
...
```sh
fuzzball workflow catalog start vllm_gemma_4_e4b_it
fuzzball workflow catalog start vllm_gemma_4_e4b_it --values Hardware=mi355x,Variant=w4a16
fuzzball workflow catalog start vllm_gemma_4_e4b_it --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `google/gemma-4-E4B-it` regardless of the variant
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/Google/gemma-4-E4B-it. Regenerate this application
