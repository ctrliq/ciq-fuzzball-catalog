...
---
id: "ciq/ml_and_ai/vllm_qwen3_5_0_8b"
name: "vLLM Qwen3.5-0.8B"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves [`Qwen/Qwen3.5-0.8B`](https://recipes.vllm.ai/Qwen/Qwen3.5-0.8B) from an
...
[vLLM recipe for Qwen3.5-0.8B](https://recipes.vllm.ai/Qwen/Qwen3.5-0.8B):
...
Qwen3.5 tiny dense multimodal model (0.8B) — ultra-low-VRAM / edge serving with
262K context

## Model

- **Checkpoint**: `Qwen/Qwen3.5-0.8B`
- **Architecture**: dense, 0.8B parameters
- **Active parameters**: 0.8B
...
```sh
fuzzball workflow catalog start vllm_qwen3_5_0_8b
fuzzball workflow catalog start vllm_qwen3_5_0_8b --values Hardware=mi355x
fuzzball workflow catalog start vllm_qwen3_5_0_8b --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `Qwen/Qwen3.5-0.8B` regardless of the variant
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/Qwen/Qwen3.5-0.8B. Regenerate this application with
