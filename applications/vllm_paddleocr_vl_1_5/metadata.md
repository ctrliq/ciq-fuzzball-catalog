...
---
id: "ciq/ml_and_ai/vllm_paddleocr_vl_1_5"
name: "vLLM PaddleOCR-VL-1.5"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`PaddlePaddle/PaddleOCR-VL-1.5`](https://recipes.vllm.ai/PaddlePaddle/PaddleOCR-VL-1.5)
...
PaddleOCR-VL-1.5](https://recipes.vllm.ai/PaddlePaddle/PaddleOCR-VL-1.5): every
...
PaddleOCR-VL-1.5 (0.9B) — next-gen compact VLM for document parsing; adds text
spotting, seal recognition, and Tibetan/Bengali

## Model

- **Checkpoint**: `PaddlePaddle/PaddleOCR-VL-1.5`
...
```sh
fuzzball workflow catalog start vllm_paddleocr_vl_1_5
fuzzball workflow catalog start vllm_paddleocr_vl_1_5 --values Hardware=mi355x
fuzzball workflow catalog start vllm_paddleocr_vl_1_5 --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `PaddlePaddle/PaddleOCR-VL-1.5` regardless of the
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/PaddlePaddle/PaddleOCR-VL-1.5. Regenerate this
