...
---
id: "ciq/ml_and_ai/vllm_qwen3_30b_a3b"
...
Serves [`Qwen/Qwen3-30B-A3B`](https://recipes.vllm.ai/Qwen/Qwen3-30B-A3B) from
...
Qwen3-30B-A3B](https://recipes.vllm.ai/Qwen/Qwen3-30B-A3B): every vLLM flag,
...
Qwen3 MoE model with 30.5B total and 3.3B active parameters, validated for BF16
serving on Intel Xeon 6.

## Model

- **Checkpoint**: `Qwen/Qwen3-30B-A3B`
- **Architecture**: moe, 30.5B parameters
...
```sh
fuzzball workflow catalog start vllm_qwen3_30b_a3b
fuzzball workflow catalog start vllm_qwen3_30b_a3b --values Hardware=mi355x
fuzzball workflow catalog start vllm_qwen3_30b_a3b --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `Qwen/Qwen3-30B-A3B` regardless of the variant
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/Qwen/Qwen3-30B-A3B. Regenerate this application with
