...
---
id: "ciq/ml_and_ai/vllm_ling_2_6_flash"
name: "vLLM Ling-2.6-flash"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`inclusionAI/Ling-2.6-flash`](https://recipes.vllm.ai/inclusionAI/Ling-2.6-flash)
...
Ling-2.6-flash](https://recipes.vllm.ai/inclusionAI/Ling-2.6-flash): every vLLM
...
Ling-2.6-flash (BailingMoeV2_5) instruct model with 104B total / 7.4B active
params, hybrid linear + MLA attention, 128K context, optimized for agent
workloads

## Model

- **Checkpoint**: `inclusionAI/Ling-2.6-flash`
- **Architecture**: moe, 104B parameters
- **Active parameters**: 7.4B
- **Context length**: 131072 tokens
- **Minimum vLLM version**: 0.20.2
...
| --- | --- | --- | --- |
| `b200` | 8x B200, 1440 GB | 4 | untested upstream |
| `b300` | 8x B300, 2144 GB | 4 | untested upstream |
| `gb200` | 4x GB200 NVL4, 768 GB | 4 | untested upstream |
| `gb300` | 4x GB300 NVL4, 1152 GB | 4 | untested upstream |
| `h100` | 8x H100, 640 GB | 4 | untested upstream |
| `h200` | 8x H200, 1128 GB | 4 | verified |
| `mi300x` | 8x MI300X, 1536 GB | 4 | verified |
| `mi325x` | 8x MI325X, 2048 GB | 4 | untested upstream |
| `mi355x` | 8x MI355X, 2304 GB | 4 | untested upstream |
...
```sh
fuzzball workflow catalog start vllm_ling_2_6_flash
fuzzball workflow catalog start vllm_ling_2_6_flash --values Hardware=mi355x
fuzzball workflow catalog start vllm_ling_2_6_flash --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `inclusionAI/Ling-2.6-flash` regardless of the
...
Image: `docker://vllm/vllm-openai:v0.20.2`
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/inclusionAI/Ling-2.6-flash. Regenerate this
