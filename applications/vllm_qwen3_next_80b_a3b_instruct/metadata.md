...
---
id: "ciq/ml_and_ai/vllm_qwen3_next_80b_a3b_instruct"
name: "vLLM Qwen3-Next-80B-A3B-Instruct"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`Qwen/Qwen3-Next-80B-A3B-Instruct`](https://recipes.vllm.ai/Qwen/Qwen3-Next-80B-A3B-Instruct)
...
Qwen3-Next-80B-A3B-Instruct](https://recipes.vllm.ai/Qwen/Qwen3-Next-80B-A3B-Instruct):
...
Advanced Qwen3-Next MoE model (80B total / 3B active) with hybrid attention,
highly sparse experts, and multi-token prediction.

## Model

- **Checkpoint**: `Qwen/Qwen3-Next-80B-A3B-Instruct`
- **Architecture**: moe, 80B parameters
...
| --- | --- | --- | --- |
| `default` | bf16 | 192 GB | `Qwen/Qwen3-Next-80B-A3B-Instruct` |
| `fp8` | fp8 | 96 GB | `Qwen/Qwen3-Next-80B-A3B-Instruct-FP8` |
| `nvfp4` | nvfp4 | 48 GB | `nvidia/Qwen3-Next-80B-A3B-Instruct-NVFP4` |
...
```sh
fuzzball workflow catalog start vllm_qwen3_next_80b_a3b_instruct
fuzzball workflow catalog start vllm_qwen3_next_80b_a3b_instruct --values Hardware=mi355x,Strategy=single_node_tp,Variant=nvfp4
fuzzball workflow catalog start vllm_qwen3_next_80b_a3b_instruct --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `Qwen/Qwen3-Next-80B-A3B-Instruct` regardless of
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/Qwen/Qwen3-Next-80B-A3B-Instruct. Regenerate this
