...
---
id: "ciq/ml_and_ai/vllm_mimo_v2_flash"
name: "vLLM MiMo-V2-Flash"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`XiaomiMiMo/MiMo-V2-Flash`](https://recipes.vllm.ai/XiaomiMiMo/MiMo-V2-Flash)
...
MiMo-V2-Flash](https://recipes.vllm.ai/XiaomiMiMo/MiMo-V2-Flash): every vLLM
...
Xiaomi's MoE reasoning model (309B total / 15B active) with hybrid attention
and MTP for fast agentic workflows

## Model

- **Checkpoint**: `XiaomiMiMo/MiMo-V2-Flash`
- **Architecture**: moe, 309B parameters
...
-  **`EnableToolCalling`** (default on): Qwen3 XML tool-call parser
-  **`EnableReasoning`** (default on): Qwen3 reasoning parser

## Usage

```sh
fuzzball workflow catalog start vllm_mimo_v2_flash
fuzzball workflow catalog start vllm_mimo_v2_flash --values Hardware=mi355x,Strategy=single_node_tp
fuzzball workflow catalog start vllm_mimo_v2_flash --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `XiaomiMiMo/MiMo-V2-Flash` regardless of the
...
vllm serve XiaomiMiMo/MiMo-V2-Flash \
  ...
  --served-model-name XiaomiMiMo/MiMo-V2-Flash
```
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/XiaomiMiMo/MiMo-V2-Flash. Regenerate this application
