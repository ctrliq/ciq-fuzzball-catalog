...
---
id: "ciq/ml_and_ai/vllm_hunyuanocr"
name: "vLLM HunyuanOCR"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves [`tencent/HunyuanOCR`](https://recipes.vllm.ai/tencent/HunyuanOCR) from
...
HunyuanOCR](https://recipes.vllm.ai/tencent/HunyuanOCR): every vLLM flag,
...
Tencent Hunyuan end-to-end OCR expert VLM (~1B) for online OCR serving with an
OpenAI-compatible API

## Model

- **Checkpoint**: `tencent/HunyuanOCR`
- **Architecture**: dense, 1B parameters
...
```sh
fuzzball workflow catalog start vllm_hunyuanocr
fuzzball workflow catalog start vllm_hunyuanocr --values Hardware=mi355x
fuzzball workflow catalog start vllm_hunyuanocr --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `tencent/HunyuanOCR` regardless of the variant
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/tencent/HunyuanOCR. Regenerate this application with
