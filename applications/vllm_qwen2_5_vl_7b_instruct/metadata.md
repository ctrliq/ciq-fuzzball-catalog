...
---
id: "ciq/ml_and_ai/vllm_qwen2_5_vl_7b_instruct"
name: "vLLM Qwen2.5-VL-7B-Instruct"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`Qwen/Qwen2.5-VL-7B-Instruct`](https://recipes.vllm.ai/Qwen/Qwen2.5-VL-7B-Instruct)
...
Qwen2.5-VL-7B-Instruct](https://recipes.vllm.ai/Qwen/Qwen2.5-VL-7B-Instruct):
...
Qwen2.5-VL dense vision-language model (7B) for image and video understanding —
fits on a single TPU v6e chip or one GPU.
...
| --- | --- | --- | --- |
| `awq` | int4 | 5 GB | `Qwen/Qwen2.5-VL-7B-Instruct-AWQ` |
| `default` | bf16 | 17 GB | `Qwen/Qwen2.5-VL-7B-Instruct` |
...
```sh
fuzzball workflow catalog start vllm_qwen2_5_vl_7b_instruct
fuzzball workflow catalog start vllm_qwen2_5_vl_7b_instruct --values Hardware=mi355x,Variant=default
fuzzball workflow catalog start vllm_qwen2_5_vl_7b_instruct --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `Qwen/Qwen2.5-VL-7B-Instruct` regardless of the
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/Qwen/Qwen2.5-VL-7B-Instruct. Regenerate this
