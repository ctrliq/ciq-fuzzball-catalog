...
---
id: "ciq/ml_and_ai/vllm_kimi_k2_thinking"
name: "vLLM Kimi-K2-Thinking"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`moonshotai/Kimi-K2-Thinking`](https://recipes.vllm.ai/moonshotai/Kimi-K2-Thinking)
...
Kimi-K2-Thinking](https://recipes.vllm.ai/moonshotai/Kimi-K2-Thinking): every
...
Kimi-K2-Thinking is an advanced reasoning MoE model with native INT4 QAT
weights, designed for long-horizon agent workflows interleaving
chain-of-thought reasoning with tool calls.

## Model

- **Checkpoint**: `moonshotai/Kimi-K2-Thinking`
...
| --- | --- | --- | --- |
| `default` | int4 | 600 GB | `moonshotai/Kimi-K2-Thinking` |
| `nvfp4` | nvfp4 | 600 GB | `nvidia/Kimi-K2-Thinking-NVFP4` |
...
```sh
fuzzball workflow catalog start vllm_kimi_k2_thinking
fuzzball workflow catalog start vllm_kimi_k2_thinking --values Hardware=mi355x,Strategy=single_node_tp,Variant=nvfp4
fuzzball workflow catalog start vllm_kimi_k2_thinking --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `moonshotai/Kimi-K2-Thinking` regardless of the
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/moonshotai/Kimi-K2-Thinking. Regenerate this
