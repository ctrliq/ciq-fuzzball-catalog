...
---
id: "ciq/ml_and_ai/vllm_qwen3_8b"
name: "vLLM Qwen3-8B"
category: "ML_AND_AI"
tags:
- LLM
...
Serves [`Qwen/Qwen3-8B`](https://recipes.vllm.ai/Qwen/Qwen3-8B) from an
...
[vLLM recipe for Qwen3-8B](https://recipes.vllm.ai/Qwen/Qwen3-8B): every vLLM
...
Qwen3 8.2B dense model with hybrid thinking/non-thinking modes, validated for
BF16 serving on Intel Xeon 6.

## Model

- **Checkpoint**: `Qwen/Qwen3-8B`
- **Architecture**: dense, 8.2B parameters
...
```sh
fuzzball workflow catalog start vllm_qwen3_8b
fuzzball workflow catalog start vllm_qwen3_8b --values Hardware=mi355x
fuzzball workflow catalog start vllm_qwen3_8b --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `Qwen/Qwen3-8B` regardless of the variant served,
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/Qwen/Qwen3-8B. Regenerate this application with
