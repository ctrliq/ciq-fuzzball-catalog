...
keyart: keyart.jpg
---
Virtual Desktop Interface (VDI) based on the Xfce desktop environment with GPU-accelerated 3D rendering through VirtualGL.
...
persistent home directory (e.g. `volume://user/persistent-4/username`).
