...
---
id: "ciq/ml_and_ai/vllm_kimi_k2_7_code"
name: "vLLM Kimi-K2.7-Code"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`moonshotai/Kimi-K2.7-Code`](https://recipes.vllm.ai/moonshotai/Kimi-K2.7-Code)
...
Kimi-K2.7-Code](https://recipes.vllm.ai/moonshotai/Kimi-K2.7-Code): every vLLM
...
Coding-focused agentic MoE built on Kimi-K2.6, tuned for long-horizon
software-engineering tasks with thinking-only reasoning, tool calling, and
vision-language input

## Model

- **Checkpoint**: `moonshotai/Kimi-K2.7-Code`
...
-  **`EnableReasoning`** (default on): Kimi K2 reasoning parser for extracting
  chain-of-thought content (Kimi-K2.7-Code is thinking-only — keep this
  enabled)
...
```sh
fuzzball workflow catalog start vllm_kimi_k2_7_code
fuzzball workflow catalog start vllm_kimi_k2_7_code --values Hardware=mi355x,Strategy=single_node_tp
fuzzball workflow catalog start vllm_kimi_k2_7_code --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `moonshotai/Kimi-K2.7-Code` regardless of the
...
vllm serve moonshotai/Kimi-K2.7-Code \
  ...
  --speculative-config '{"model":"lightseekorg/kimi-k2.7-coder-eagle3.1-mla","method":"eagle3","num_speculative_tokens":3}' \
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/moonshotai/Kimi-K2.7-Code. Regenerate this
