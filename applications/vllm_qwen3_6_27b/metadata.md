...
---
id: "ciq/ml_and_ai/vllm_qwen3_6_27b"
...
Serves [`Qwen/Qwen3.6-27B`](https://recipes.vllm.ai/Qwen/Qwen3.6-27B) from an
...
[vLLM recipe for Qwen3.6-27B](https://recipes.vllm.ai/Qwen/Qwen3.6-27B): every
...
Qwen3.6 dense multimodal model (27B) with gated delta networks hybrid
...
| --- | --- | --- | --- |
| `default` | bf16 | 65 GB | `Qwen/Qwen3.6-27B` |
| `fp8` | fp8 | 33 GB | `Qwen/Qwen3.6-27B-FP8` |
| `nvfp4` | nvfp4 | 27 GB | `nvidia/Qwen3.6-27B-NVFP4` |
...
```sh
fuzzball workflow catalog start vllm_qwen3_6_27b
fuzzball workflow catalog start vllm_qwen3_6_27b --values Hardware=rtx_pro_6000,Variant=nvfp4
fuzzball workflow catalog start vllm_qwen3_6_27b --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `Qwen/Qwen3.6-27B` regardless of the variant
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/Qwen/Qwen3.6-27B. Regenerate this application with
