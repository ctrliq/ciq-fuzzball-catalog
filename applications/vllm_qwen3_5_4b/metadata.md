...
---
id: "ciq/ml_and_ai/vllm_qwen3_5_4b"
name: "vLLM Qwen3.5-4B"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves [`Qwen/Qwen3.5-4B`](https://recipes.vllm.ai/Qwen/Qwen3.5-4B) from an
...
[vLLM recipe for Qwen3.5-4B](https://recipes.vllm.ai/Qwen/Qwen3.5-4B): every
...
Qwen3.5 compact dense multimodal model (4B) — fits on 16 GB consumer GPUs with
full 262K context or one Xeon 6 NUMA node
...
```sh
fuzzball workflow catalog start vllm_qwen3_5_4b
fuzzball workflow catalog start vllm_qwen3_5_4b --values Hardware=mi355x
fuzzball workflow catalog start vllm_qwen3_5_4b --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `Qwen/Qwen3.5-4B` regardless of the variant
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/Qwen/Qwen3.5-4B. Regenerate this application with
