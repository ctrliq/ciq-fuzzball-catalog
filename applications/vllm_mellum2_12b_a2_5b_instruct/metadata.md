...
---
id: "ciq/ml_and_ai/vllm_mellum2_12b_a2_5b_instruct"
name: "vLLM Mellum2-12B-A2.5B-Instruct"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`JetBrains/Mellum2-12B-A2.5B-Instruct`](https://recipes.vllm.ai/JetBrains/Mellum2-12B-A2.5B-Instruct)
...
Mellum2-12B-A2.5B-Instruct](https://recipes.vllm.ai/JetBrains/Mellum2-12B-A2.5B-Instruct):
...
JetBrains' instruction-tuned code MoE (12B total / 2.5B active) that answers
directly without an externalized chain of thought — low-latency coding and tool
use

## Model

- **Checkpoint**: `JetBrains/Mellum2-12B-A2.5B-Instruct`
...
```sh
fuzzball workflow catalog start vllm_mellum2_12b_a2_5b_instruct
fuzzball workflow catalog start vllm_mellum2_12b_a2_5b_instruct --values Hardware=mi355x,Strategy=single_node_tp
fuzzball workflow catalog start vllm_mellum2_12b_a2_5b_instruct --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `JetBrains/Mellum2-12B-A2.5B-Instruct` regardless
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/JetBrains/Mellum2-12B-A2.5B-Instruct. Regenerate this
