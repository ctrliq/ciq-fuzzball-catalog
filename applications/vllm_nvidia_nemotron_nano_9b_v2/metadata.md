...
---
id: "ciq/ml_and_ai/vllm_nvidia_nemotron_nano_9b_v2"
name: "vLLM NVIDIA-Nemotron-Nano-9B-v2"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`nvidia/NVIDIA-Nemotron-Nano-9B-v2`](https://recipes.vllm.ai/nvidia/NVIDIA-Nemotron-Nano-9B-v2)
...
Nemotron-Nano-9B-v2](https://recipes.vllm.ai/nvidia/NVIDIA-Nemotron-Nano-9B-v2):
...
NVIDIA Nemotron-Nano 9B (Mamba-hybrid dense) reasoning + tool-use model with
FP8 / NVFP4 / Japanese variants

## Model

- **Checkpoint**: `nvidia/NVIDIA-Nemotron-Nano-9B-v2`
...
| --- | --- | --- | --- |
| `base` | bf16 | 22 GB | `nvidia/NVIDIA-Nemotron-Nano-9B-v2-Base` |
| `default` | bf16 | 22 GB | `nvidia/NVIDIA-Nemotron-Nano-9B-v2` |
| `fp8` | fp8 | 11 GB | `nvidia/NVIDIA-Nemotron-Nano-9B-v2-FP8` |
| `japanese` | bf16 | 22 GB | `nvidia/NVIDIA-Nemotron-Nano-9B-v2-Japanese` |
| `nvfp4` | nvfp4 | 6 GB | `nvidia/NVIDIA-Nemotron-Nano-9B-v2-NVFP4` |

## Features

-  **`EnableToolCalling`** (default on): Custom Nemotron tool-call parser
  plugin (download: nemotron_toolcall_parser_no_streaming.py)

## Usage

```sh
fuzzball workflow catalog start vllm_nvidia_nemotron_nano_9b_v2
fuzzball workflow catalog start vllm_nvidia_nemotron_nano_9b_v2 --values Hardware=mi355x,Variant=nvfp4
fuzzball workflow catalog start vllm_nvidia_nemotron_nano_9b_v2 --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `nvidia/NVIDIA-Nemotron-Nano-9B-v2` regardless of
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/nvidia/NVIDIA-Nemotron-Nano-9B-v2. Regenerate this
