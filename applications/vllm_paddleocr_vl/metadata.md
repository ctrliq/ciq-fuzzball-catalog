...
---
id: "ciq/ml_and_ai/vllm_paddleocr_vl"
name: "vLLM PaddleOCR-VL"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`PaddlePaddle/PaddleOCR-VL`](https://recipes.vllm.ai/PaddlePaddle/PaddleOCR-VL)
...
PaddleOCR-VL](https://recipes.vllm.ai/PaddlePaddle/PaddleOCR-VL): every vLLM
...
PaddleOCR-VL (0.9B) — compact vision-language model for document parsing, OCR,
...
```sh
fuzzball workflow catalog start vllm_paddleocr_vl
fuzzball workflow catalog start vllm_paddleocr_vl --values Hardware=mi355x
fuzzball workflow catalog start vllm_paddleocr_vl --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `PaddlePaddle/PaddleOCR-VL` regardless of the
...
vllm serve PaddlePaddle/PaddleOCR-VL \
  ...
  --served-model-name PaddlePaddle/PaddleOCR-VL
```
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/PaddlePaddle/PaddleOCR-VL. Regenerate this
