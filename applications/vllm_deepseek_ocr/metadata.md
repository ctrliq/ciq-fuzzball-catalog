...
---
id: "ciq/ml_and_ai/vllm_deepseek_ocr"
name: "vLLM DeepSeek-OCR"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`deepseek-ai/DeepSeek-OCR`](https://recipes.vllm.ai/deepseek-ai/DeepSeek-OCR)
...
DeepSeek-OCR](https://recipes.vllm.ai/deepseek-ai/DeepSeek-OCR): every vLLM
...
Frontier OCR model exploring optical context compression for LLMs, optimized
for document parsing and markdown generation.

## Model

- **Checkpoint**: `deepseek-ai/DeepSeek-OCR`
...
```sh
fuzzball workflow catalog start vllm_deepseek_ocr
fuzzball workflow catalog start vllm_deepseek_ocr --values Hardware=mi355x
fuzzball workflow catalog start vllm_deepseek_ocr --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `deepseek-ai/DeepSeek-OCR` regardless of the
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/deepseek-ai/DeepSeek-OCR. Regenerate this application
