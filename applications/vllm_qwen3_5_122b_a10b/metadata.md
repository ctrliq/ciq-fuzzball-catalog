...
---
id: "ciq/ml_and_ai/vllm_qwen3_5_122b_a10b"
name: "vLLM Qwen3.5-122B-A10B"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`Qwen/Qwen3.5-122B-A10B`](https://recipes.vllm.ai/Qwen/Qwen3.5-122B-A10B) from
...
Qwen3.5-122B-A10B](https://recipes.vllm.ai/Qwen/Qwen3.5-122B-A10B): every vLLM
...
Mid-size Qwen3.5 multimodal MoE (122B total / 10B active) with gated delta
networks, 256 experts, and 262K context

## Model

- **Checkpoint**: `Qwen/Qwen3.5-122B-A10B`
- **Architecture**: moe, 122B parameters
...
| --- | --- | --- | --- |
| `default` | bf16 | 293 GB | `Qwen/Qwen3.5-122B-A10B` |
| `fp8` | fp8 | 147 GB | `Qwen/Qwen3.5-122B-A10B-FP8` |
| `gptq_int4` | int4 | 74 GB | `Qwen/Qwen3.5-122B-A10B-GPTQ-Int4` |
...
```sh
fuzzball workflow catalog start vllm_qwen3_5_122b_a10b
fuzzball workflow catalog start vllm_qwen3_5_122b_a10b --values Hardware=mi355x,Strategy=single_node_tp,Variant=gptq_int4
fuzzball workflow catalog start vllm_qwen3_5_122b_a10b --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `Qwen/Qwen3.5-122B-A10B` regardless of the variant
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/Qwen/Qwen3.5-122B-A10B. Regenerate this application
