...
---
id: "ciq/ml_and_ai/vllm_ernie_4_5_vl_28b_a3b_pt"
name: "vLLM ERNIE-4.5-VL-28B-A3B-PT"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`baidu/ERNIE-4.5-VL-28B-A3B-PT`](https://recipes.vllm.ai/baidu/ERNIE-4.5-VL-28B-A3B-PT)
...
ERNIE-4.5-VL](https://recipes.vllm.ai/baidu/ERNIE-4.5-VL-28B-A3B-PT): every
...
Baidu ERNIE 4.5 VL MoE vision-language models (28B-A3B, 424B-A47B) with
heterogeneous text/vision experts

## Model

- **Checkpoint**: `baidu/ERNIE-4.5-VL-28B-A3B-PT`
- **Architecture**: moe, 28B parameters
...
| --- | --- | --- | --- |
| `424b` | bf16 | 1120 GB | `baidu/ERNIE-4.5-VL-424B-A47B-PT` |
| `424b_fp8` | fp8 | 640 GB | `baidu/ERNIE-4.5-VL-424B-A47B-PT` |
| `default` | bf16 | 67 GB | `baidu/ERNIE-4.5-VL-28B-A3B-PT` |
...
```sh
fuzzball workflow catalog start vllm_ernie_4_5_vl_28b_a3b_pt
fuzzball workflow catalog start vllm_ernie_4_5_vl_28b_a3b_pt --values Hardware=mi355x,Variant=default
fuzzball workflow catalog start vllm_ernie_4_5_vl_28b_a3b_pt --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `baidu/ERNIE-4.5-VL-28B-A3B-PT` regardless of the
...
vllm serve baidu/ERNIE-4.5-VL-28B-A3B-PT \
  ...
  --served-model-name baidu/ERNIE-4.5-VL-28B-A3B-PT
```
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/baidu/ERNIE-4.5-VL-28B-A3B-PT. Regenerate this
