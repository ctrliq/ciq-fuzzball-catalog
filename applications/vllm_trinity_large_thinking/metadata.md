...
---
id: "ciq/ml_and_ai/vllm_trinity_large_thinking"
name: "vLLM Trinity-Large-Thinking"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`arcee-ai/Trinity-Large-Thinking`](https://recipes.vllm.ai/arcee-ai/Trinity-Large-Thinking)
...
Trinity-Large-Thinking](https://recipes.vllm.ai/arcee-ai/Trinity-Large-Thinking):
...
Arcee AI's reasoning-focused sparse MoE (AfmoeForCausalLM) with structured
<think> traces and agentic tool use

## Model

- **Checkpoint**: `arcee-ai/Trinity-Large-Thinking`
- **Architecture**: moe, 398B parameters
...
| --- | --- | --- | --- |
| `default` | bf16 | 955 GB | `arcee-ai/Trinity-Large-Thinking` |
| `nvfp4` | nvfp4 | 239 GB | `arcee-ai/Trinity-Large-Thinking-NVFP4` |
...
```sh
fuzzball workflow catalog start vllm_trinity_large_thinking
fuzzball workflow catalog start vllm_trinity_large_thinking --values Hardware=mi355x,Variant=nvfp4
fuzzball workflow catalog start vllm_trinity_large_thinking --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `arcee-ai/Trinity-Large-Thinking` regardless of
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/arcee-ai/Trinity-Large-Thinking. Regenerate this
