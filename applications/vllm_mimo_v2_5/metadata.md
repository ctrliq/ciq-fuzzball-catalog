...
---
id: "ciq/ml_and_ai/vllm_mimo_v2_5"
name: "vLLM MiMo-V2.5"
category: "ML_AND_AI"
tags:
- LLM
...
Serves [`XiaomiMiMo/MiMo-V2.5`](https://recipes.vllm.ai/XiaomiMiMo/MiMo-V2.5)
...
MiMo-V2.5](https://recipes.vllm.ai/XiaomiMiMo/MiMo-V2.5): every vLLM flag,
...
MiMo-V2.5 is a native omnimodal model with strong agentic capabilities,
supporting text, image, video, and audio understanding within a unified
architecture

## Model

- **Checkpoint**: `XiaomiMiMo/MiMo-V2.5`
- **Architecture**: moe, 311B parameters
...
| `mi300x` | 8x MI300X, 1536 GB | 4/8 | untested upstream |
| `mi325x` | 8x MI325X, 2048 GB | 4/8 | untested upstream |
| `mi355x` | 8x MI355X, 2304 GB | 4/8 | untested upstream |
...
```sh
fuzzball workflow catalog start vllm_mimo_v2_5
fuzzball workflow catalog start vllm_mimo_v2_5 --values Hardware=mi355x,Strategy=single_node_tp
fuzzball workflow catalog start vllm_mimo_v2_5 --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `XiaomiMiMo/MiMo-V2.5` regardless of the variant
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/XiaomiMiMo/MiMo-V2.5. Regenerate this application
