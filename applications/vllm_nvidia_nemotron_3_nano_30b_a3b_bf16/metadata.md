...
---
id: "ciq/ml_and_ai/vllm_nvidia_nemotron_3_nano_30b_a3b_bf16"
name: "vLLM NVIDIA-Nemotron-3-Nano-30B-A3B-BF16"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16`](https://recipes.vllm.ai/nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16)
...
Nemotron-3-Nano-30B-A3B](https://recipes.vllm.ai/nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16):
...
NVIDIA Nemotron-3-Nano Mamba-hybrid MoE (30B total / ~3B active) with BF16 and
FP8 variants
...
| --- | --- | --- | --- |
| `default` | bf16 | 72 GB | `nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16` |
| `fp8` | fp8 | 35 GB | `nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-FP8` |
...
```sh
fuzzball workflow catalog start vllm_nvidia_nemotron_3_nano_30b_a3b_bf16
fuzzball workflow catalog start vllm_nvidia_nemotron_3_nano_30b_a3b_bf16 --values Hardware=mi355x,Variant=fp8
fuzzball workflow catalog start vllm_nvidia_nemotron_3_nano_30b_a3b_bf16 --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16`
