...
---
id: "ciq/ml_and_ai/vllm_mellum2_12b_a2_5b_thinking"
name: "vLLM Mellum2-12B-A2.5B-Thinking"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`JetBrains/Mellum2-12B-A2.5B-Thinking`](https://recipes.vllm.ai/JetBrains/Mellum2-12B-A2.5B-Thinking)
...
Mellum2-12B-A2.5B-Thinking](https://recipes.vllm.ai/JetBrains/Mellum2-12B-A2.5B-Thinking):
...
JetBrains' reasoning-augmented code MoE (12B total / 2.5B active) that emits
explicit <think> chains for debugging, planning, and agentic coding

## Model

- **Checkpoint**: `JetBrains/Mellum2-12B-A2.5B-Thinking`
- **Architecture**: moe, 12B parameters
...
-  **`EnableReasoning`** (default on): Parse the model's <think>...</think>
  reasoning blocks (Qwen3-style parser)
-  **`EnableToolCalling`** (default on): Hermes tool-call parser for function
  calling

## Usage

```sh
fuzzball workflow catalog start vllm_mellum2_12b_a2_5b_thinking
fuzzball workflow catalog start vllm_mellum2_12b_a2_5b_thinking --values Hardware=mi355x,Strategy=single_node_tp
fuzzball workflow catalog start vllm_mellum2_12b_a2_5b_thinking --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `JetBrains/Mellum2-12B-A2.5B-Thinking` regardless
...
vllm serve JetBrains/Mellum2-12B-A2.5B-Thinking \
  ...
  --served-model-name JetBrains/Mellum2-12B-A2.5B-Thinking
```
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/JetBrains/Mellum2-12B-A2.5B-Thinking. Regenerate this
