...
---
id: "ciq/ml_and_ai/vllm_plamo_2_translate"
name: "vLLM plamo-2-translate"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`pfnet/plamo-2-translate`](https://recipes.vllm.ai/pfnet/plamo-2-translate)
...
from the [vLLM recipe for PLaMo 2
Translate](https://recipes.vllm.ai/pfnet/plamo-2-translate): every vLLM flag,
...
Post-trained PLaMo 2 translation model specialized for English/Japanese
translation tasks.

## Model

- **Checkpoint**: `pfnet/plamo-2-translate`
- **Architecture**: dense, 9.5B parameters
- **Active parameters**: 9.5B
...
```sh
fuzzball workflow catalog start vllm_plamo_2_translate
fuzzball workflow catalog start vllm_plamo_2_translate --values Hardware=mi355x
fuzzball workflow catalog start vllm_plamo_2_translate --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `pfnet/plamo-2-translate` regardless of the
...
vllm serve pfnet/plamo-2-translate \
  ...
  --served-model-name pfnet/plamo-2-translate
```
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/pfnet/plamo-2-translate. Regenerate this application
