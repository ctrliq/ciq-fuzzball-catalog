...
---
id: "ciq/ml_and_ai/vllm_glm_asr_nano_2512"
name: "vLLM GLM-ASR-Nano-2512"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`zai-org/GLM-ASR-Nano-2512`](https://recipes.vllm.ai/zai-org/GLM-ASR-Nano-2512)
...
GLM-ASR-Nano-2512](https://recipes.vllm.ai/zai-org/GLM-ASR-Nano-2512): every
...
Open-source speech recognition model (~2B) with strong dialect support
(Cantonese and others) and robust low-volume speech transcription

## Model

- **Checkpoint**: `zai-org/GLM-ASR-Nano-2512`
- **Architecture**: dense, 2.3B parameters
...
```sh
fuzzball workflow catalog start vllm_glm_asr_nano_2512
fuzzball workflow catalog start vllm_glm_asr_nano_2512 --values Hardware=mi355x
fuzzball workflow catalog start vllm_glm_asr_nano_2512 --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `zai-org/GLM-ASR-Nano-2512` regardless of the
...
vllm serve zai-org/GLM-ASR-Nano-2512 \
  ...
  --served-model-name zai-org/GLM-ASR-Nano-2512
```
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/zai-org/GLM-ASR-Nano-2512. Regenerate this
