...
---
id: "ciq/ml_and_ai/vllm_lfm2_5_1_2b_instruct"
name: "vLLM LFM2.5-1.2B-Instruct"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`LiquidAI/LFM2.5-1.2B-Instruct`](https://recipes.vllm.ai/LiquidAI/LFM2.5-1.2B-Instruct)
...
Instruct](https://recipes.vllm.ai/LiquidAI/LFM2.5-1.2B-Instruct): every vLLM
...
Liquid AI's 1.2B instruction-tuned model on the LFM2 hybrid conv+attention
backbone, with tool calling and a 32K context window on a single small GPU.
...
```sh
fuzzball workflow catalog start vllm_lfm2_5_1_2b_instruct
fuzzball workflow catalog start vllm_lfm2_5_1_2b_instruct --values Hardware=mi355x
fuzzball workflow catalog start vllm_lfm2_5_1_2b_instruct --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `LiquidAI/LFM2.5-1.2B-Instruct` regardless of the
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/LiquidAI/LFM2.5-1.2B-Instruct. Regenerate this
