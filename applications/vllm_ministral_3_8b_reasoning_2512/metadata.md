...
---
id: "ciq/ml_and_ai/vllm_ministral_3_8b_reasoning_2512"
name: "vLLM Ministral-3-8B-Reasoning-2512"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`mistralai/Ministral-3-8B-Reasoning-2512`](https://recipes.vllm.ai/mistralai/Ministral-3-8B-Reasoning-2512)
...
Ministral-3-Reasoning](https://recipes.vllm.ai/mistralai/Ministral-3-8B-Reasoning-2512):
...
Ministral 3 Reasoning family (3B/8B/14B) with BF16 weights, vision support, and
256K context
...
| --- | --- | --- | --- |
| `14b` | bf16 | 32 GB | `mistralai/Ministral-3-14B-Reasoning-2512` |
| `3b` | bf16 | 8 GB | `mistralai/Ministral-3-3B-Reasoning-2512` |
| `default` | bf16 | 22 GB | `mistralai/Ministral-3-8B-Reasoning-2512` |
...
-  **`EnableReasoning`** (default on): Mistral reasoning parser extracts
  <think>...</think> into message.reasoning
...
```sh
fuzzball workflow catalog start vllm_ministral_3_8b_reasoning_2512
fuzzball workflow catalog start vllm_ministral_3_8b_reasoning_2512 --values Hardware=mi355x,Variant=default
fuzzball workflow catalog start vllm_ministral_3_8b_reasoning_2512 --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `mistralai/Ministral-3-8B-Reasoning-2512`
...
vllm serve mistralai/Ministral-3-8B-Reasoning-2512 \
  ...
  --served-model-name mistralai/Ministral-3-8B-Reasoning-2512
```
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/mistralai/Ministral-3-8B-Reasoning-2512. Regenerate
