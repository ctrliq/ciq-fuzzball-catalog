...
---
id: "ciq/ml_and_ai/vllm_qwen3_asr_1_7b"
...
Serves [`Qwen/Qwen3-ASR-1.7B`](https://recipes.vllm.ai/Qwen/Qwen3-ASR-1.7B)
...
Qwen3-ASR-1.7B](https://recipes.vllm.ai/Qwen/Qwen3-ASR-1.7B): every vLLM flag,
...
Speech-to-text model supporting 11 languages, multiple accents, and singing
voice with customizable text-context prompting.
...
```sh
fuzzball workflow catalog start vllm_qwen3_asr_1_7b
fuzzball workflow catalog start vllm_qwen3_asr_1_7b --values Hardware=mi355x
fuzzball workflow catalog start vllm_qwen3_asr_1_7b --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `Qwen/Qwen3-ASR-1.7B` regardless of the variant
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/Qwen/Qwen3-ASR-1.7B. Regenerate this application with
