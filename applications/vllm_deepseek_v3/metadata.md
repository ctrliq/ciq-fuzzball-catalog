...
---
id: "ciq/ml_and_ai/vllm_deepseek_v3"
...
Serves
[`deepseek-ai/DeepSeek-V3`](https://recipes.vllm.ai/deepseek-ai/DeepSeek-V3)
...
DeepSeek-V3](https://recipes.vllm.ai/deepseek-ai/DeepSeek-V3): every vLLM flag,
...
DeepSeek-V3 is a 671B-parameter Mixture-of-Experts model with native FP8
weights and strong reasoning, coding, and math capabilities.
...
| --- | --- | --- | --- |
| `default` | fp8 | 805 GB | `deepseek-ai/DeepSeek-V3` |
| `fp4` | fp4 | 403 GB | `nvidia/DeepSeek-V3-FP4` |
...
-  **`EnableToolCalling`** (default on): Enable DeepSeek-V3 tool calling with
...
```sh
fuzzball workflow catalog start vllm_deepseek_v3
fuzzball workflow catalog start vllm_deepseek_v3 --values Hardware=mi355x,Strategy=single_node_tp,Variant=fp4
fuzzball workflow catalog start vllm_deepseek_v3 --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `deepseek-ai/DeepSeek-V3` regardless of the
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/deepseek-ai/DeepSeek-V3. Regenerate this application
