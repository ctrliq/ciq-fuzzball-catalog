...
---
id: "ciq/ml_and_ai/vllm_qwen3_5_2b"
...
Serves [`Qwen/Qwen3.5-2B`](https://recipes.vllm.ai/Qwen/Qwen3.5-2B) from an
...
[vLLM recipe for Qwen3.5-2B](https://recipes.vllm.ai/Qwen/Qwen3.5-2B): every
...
Qwen3.5 mini dense multimodal model (2B) — edge / low-VRAM serving with 262K
context

## Model

- **Checkpoint**: `Qwen/Qwen3.5-2B`
- **Architecture**: dense, 2B parameters
...
```sh
fuzzball workflow catalog start vllm_qwen3_5_2b
fuzzball workflow catalog start vllm_qwen3_5_2b --values Hardware=mi355x
fuzzball workflow catalog start vllm_qwen3_5_2b --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `Qwen/Qwen3.5-2B` regardless of the variant
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/Qwen/Qwen3.5-2B. Regenerate this application with
