...
---
id: "ciq/ml_and_ai/vllm_lfm2_5_350m"
name: "vLLM LFM2.5-350M"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves [`LiquidAI/LFM2.5-350M`](https://recipes.vllm.ai/LiquidAI/LFM2.5-350M)
...
350M](https://recipes.vllm.ai/LiquidAI/LFM2.5-350M): every vLLM flag,
...
Liquid AI's smallest LFM2.5 chat model (350M) on the LFM2 hybrid conv+attention
backbone — tool calling and 32K context, light enough for edge GPUs.

## Model

- **Checkpoint**: `LiquidAI/LFM2.5-350M`
- **Architecture**: dense, 350M parameters
- **Active parameters**: 350M
...
```sh
fuzzball workflow catalog start vllm_lfm2_5_350m
fuzzball workflow catalog start vllm_lfm2_5_350m --values Hardware=mi355x
fuzzball workflow catalog start vllm_lfm2_5_350m --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `LiquidAI/LFM2.5-350M` regardless of the variant
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/LiquidAI/LFM2.5-350M. Regenerate this application
