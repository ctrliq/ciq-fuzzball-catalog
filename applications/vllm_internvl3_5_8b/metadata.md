...
---
id: "ciq/ml_and_ai/vllm_internvl3_5_8b"
name: "vLLM InternVL3_5-8B"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`OpenGVLab/InternVL3_5-8B`](https://recipes.vllm.ai/OpenGVLab/InternVL3_5-8B)
...
InternVL3.5](https://recipes.vllm.ai/OpenGVLab/InternVL3_5-8B): every vLLM
...
InternVL 3.5 vision-language models from Shanghai AI Lab with thinking-mode
prompting

## Model

- **Checkpoint**: `OpenGVLab/InternVL3_5-8B`
...
```sh
fuzzball workflow catalog start vllm_internvl3_5_8b
fuzzball workflow catalog start vllm_internvl3_5_8b --values Hardware=mi355x
fuzzball workflow catalog start vllm_internvl3_5_8b --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `OpenGVLab/InternVL3_5-8B` regardless of the
...
vllm serve OpenGVLab/InternVL3_5-8B \
  ...
  --served-model-name OpenGVLab/InternVL3_5-8B
```
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/OpenGVLab/InternVL3_5-8B. Regenerate this application
