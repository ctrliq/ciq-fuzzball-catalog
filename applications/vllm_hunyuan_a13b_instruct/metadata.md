...
---
id: "ciq/ml_and_ai/vllm_hunyuan_a13b_instruct"
name: "vLLM Hunyuan-A13B-Instruct"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`tencent/Hunyuan-A13B-Instruct`](https://recipes.vllm.ai/tencent/Hunyuan-A13B-Instruct)
...
Hunyuan-A13B-Instruct](https://recipes.vllm.ai/tencent/Hunyuan-A13B-Instruct):
...
Tencent Hunyuan A13B instruct-tuned MoE language model with AITER-accelerated
AMD ROCm deployment

## Model

- **Checkpoint**: `tencent/Hunyuan-A13B-Instruct`
...
| --- | --- | --- | --- |
| `default` | bf16 | 580 GB | `tencent/Hunyuan-A13B-Instruct` |
| `fp8` | fp8 | 96 GB | `tencent/Hunyuan-A13B-Instruct-FP8` |
...
```sh
fuzzball workflow catalog start vllm_hunyuan_a13b_instruct
fuzzball workflow catalog start vllm_hunyuan_a13b_instruct --values Hardware=mi355x,Strategy=single_node_tp,Variant=fp8
fuzzball workflow catalog start vllm_hunyuan_a13b_instruct --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `tencent/Hunyuan-A13B-Instruct` regardless of the
...
vllm serve tencent/Hunyuan-A13B-Instruct \
  ...
  --served-model-name tencent/Hunyuan-A13B-Instruct
```
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/tencent/Hunyuan-A13B-Instruct. Regenerate this
