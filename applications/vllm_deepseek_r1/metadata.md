...
---
id: "ciq/ml_and_ai/vllm_deepseek_r1"
...
Serves
[`deepseek-ai/DeepSeek-R1`](https://recipes.vllm.ai/deepseek-ai/DeepSeek-R1)
...
DeepSeek-R1](https://recipes.vllm.ai/deepseek-ai/DeepSeek-R1): every vLLM flag,
...
DeepSeek-R1 is a 671B-parameter MoE reasoning model built on the DeepSeek-V3
architecture, trained with large-scale reinforcement learning for strong
chain-of-thought capabilities.

## Model

- **Checkpoint**: `deepseek-ai/DeepSeek-R1`
...
| --- | --- | --- | --- |
| `default` | fp8 | 805 GB | `deepseek-ai/DeepSeek-R1` |
| `nvfp4` | nvfp4 | 403 GB | `nvidia/DeepSeek-R1-0528-NVFP4-v2` |
| `r1_0528` | fp8 | 805 GB | `deepseek-ai/DeepSeek-R1-0528` |
...
-  **`EnableToolCalling`** (default on): Enable DeepSeek-R1 tool calling with
  the deepseek_v3 tool-call parser.
...
```sh
fuzzball workflow catalog start vllm_deepseek_r1
fuzzball workflow catalog start vllm_deepseek_r1 --values Hardware=mi355x,Strategy=single_node_tp,Variant=r1_0528
fuzzball workflow catalog start vllm_deepseek_r1 --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `deepseek-ai/DeepSeek-R1` regardless of the
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/deepseek-ai/DeepSeek-R1. Regenerate this application
