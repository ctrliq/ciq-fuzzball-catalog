...
---
id: "ciq/ml_and_ai/vllm_laguna_xs_2_1"
name: "vLLM Laguna-XS-2.1"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`poolside/Laguna-XS-2.1`](https://recipes.vllm.ai/poolside/Laguna-XS-2.1) from
...
XS-2.1](https://recipes.vllm.ai/poolside/Laguna-XS-2.1): every vLLM flag,
...
- **Checkpoint**: `poolside/Laguna-XS-2.1`
...
| --- | --- | --- | --- |
| `default` | bf16 | 80 GB | `poolside/Laguna-XS-2.1` |
| `fp8` | fp8 | 40 GB | `poolside/Laguna-XS-2.1-FP8` |
| `int4` | int4 | 29 GB | `poolside/Laguna-XS-2.1-INT4` |
| `nvfp4` | nvfp4 | 26 GB | `poolside/Laguna-XS-2.1-NVFP4` |
...
-  **`EnableSpecDecoding`** (default off): DFlash speculative decoding with the
  Laguna-XS-2.1 draft model (15 tokens, greedy)

## Usage

```sh
fuzzball workflow catalog start vllm_laguna_xs_2_1
fuzzball workflow catalog start vllm_laguna_xs_2_1 --values Hardware=mi355x,Strategy=single_node_tp,Variant=nvfp4
fuzzball workflow catalog start vllm_laguna_xs_2_1 --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `poolside/Laguna-XS-2.1` regardless of the variant
...
vllm serve poolside/Laguna-XS-2.1 \
  ...
  --served-model-name poolside/Laguna-XS-2.1
```
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/poolside/Laguna-XS-2.1. Regenerate this application
