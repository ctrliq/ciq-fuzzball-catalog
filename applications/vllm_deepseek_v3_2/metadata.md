...
---
id: "ciq/ml_and_ai/vllm_deepseek_v3_2"
...
Serves
[`deepseek-ai/DeepSeek-V3.2`](https://recipes.vllm.ai/deepseek-ai/DeepSeek-V3.2)
...
DeepSeek-V3.2](https://recipes.vllm.ai/deepseek-ai/DeepSeek-V3.2): every vLLM
...
DeepSeek V3.2 MoE model with MLA attention, sparse attention, and scalable RL
for strong reasoning and agent capabilities.

## Model

- **Checkpoint**: `deepseek-ai/DeepSeek-V3.2`
...
| --- | --- | --- | --- |
| `default` | fp8 | 805 GB | `deepseek-ai/DeepSeek-V3.2` |
| `nvfp4` | nvfp4 | 403 GB | `nvidia/DeepSeek-V3.2-NVFP4` |
...
-  **`EnableSpecDecoding`** (default off): Multi-Token Prediction speculative
  decoding with 3 speculative tokens.

## Usage

```sh
fuzzball workflow catalog start vllm_deepseek_v3_2
fuzzball workflow catalog start vllm_deepseek_v3_2 --values Hardware=mi355x,Strategy=single_node_tp,Variant=nvfp4
fuzzball workflow catalog start vllm_deepseek_v3_2 --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `deepseek-ai/DeepSeek-V3.2` regardless of the
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/deepseek-ai/DeepSeek-V3.2. Regenerate this
