...
---
id: "ciq/ml_and_ai/vllm_qwen3_5_35b_a3b"
name: "vLLM Qwen3.5-35B-A3B"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves [`Qwen/Qwen3.5-35B-A3B`](https://recipes.vllm.ai/Qwen/Qwen3.5-35B-A3B)
...
Qwen3.5-35B-A3B](https://recipes.vllm.ai/Qwen/Qwen3.5-35B-A3B): every vLLM
...
Compact Qwen3.5 multimodal MoE (35B total / 3B active) with gated delta
...
| --- | --- | --- | --- |
| `default` | bf16 | 84 GB | `Qwen/Qwen3.5-35B-A3B` |
| `fp8` | fp8 | 42 GB | `Qwen/Qwen3.5-35B-A3B-FP8` |
| `gptq_int4` | int4 | 21 GB | `Qwen/Qwen3.5-35B-A3B-GPTQ-Int4` |
...
```sh
fuzzball workflow catalog start vllm_qwen3_5_35b_a3b
fuzzball workflow catalog start vllm_qwen3_5_35b_a3b --values Hardware=mi355x,Strategy=single_node_tp,Variant=gptq_int4
fuzzball workflow catalog start vllm_qwen3_5_35b_a3b --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `Qwen/Qwen3.5-35B-A3B` regardless of the variant
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/Qwen/Qwen3.5-35B-A3B. Regenerate this application
