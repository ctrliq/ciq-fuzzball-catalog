...
---
id: "ciq/ml_and_ai/vllm_plamo_3_nict_31b_base"
name: "vLLM plamo-3-nict-31b-base"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`pfnet/plamo-3-nict-31b-base`](https://recipes.vllm.ai/pfnet/plamo-3-nict-31b-base)
...
from the [vLLM recipe for PLaMo 3 NICT 31B
Base](https://recipes.vllm.ai/pfnet/plamo-3-nict-31b-base): every vLLM flag,
...
Largest PLaMo 3 NICT Japanese/English base model with interleaved
sliding-window and full attention.

## Model

- **Checkpoint**: `pfnet/plamo-3-nict-31b-base`
...
```sh
fuzzball workflow catalog start vllm_plamo_3_nict_31b_base
fuzzball workflow catalog start vllm_plamo_3_nict_31b_base --values Hardware=mi355x
fuzzball workflow catalog start vllm_plamo_3_nict_31b_base --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `pfnet/plamo-3-nict-31b-base` regardless of the
...
vllm serve pfnet/plamo-3-nict-31b-base \
  ...
  --served-model-name pfnet/plamo-3-nict-31b-base
```
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/pfnet/plamo-3-nict-31b-base. Regenerate this
