...
---
id: "ciq/ml_and_ai/vllm_lfm2_5_1_2b_base"
name: "vLLM LFM2.5-1.2B-Base"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`LiquidAI/LFM2.5-1.2B-Base`](https://recipes.vllm.ai/LiquidAI/LFM2.5-1.2B-Base)
...
Base](https://recipes.vllm.ai/LiquidAI/LFM2.5-1.2B-Base): every vLLM flag,
...
Liquid AI's 1.2B pretrained base model on the LFM2 hybrid conv+attention
backbone — a text-completion and fine-tuning foundation (no chat template).

## Model

- **Checkpoint**: `LiquidAI/LFM2.5-1.2B-Base`
...
```sh
fuzzball workflow catalog start vllm_lfm2_5_1_2b_base
fuzzball workflow catalog start vllm_lfm2_5_1_2b_base --values Hardware=mi355x
fuzzball workflow catalog start vllm_lfm2_5_1_2b_base --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `LiquidAI/LFM2.5-1.2B-Base` regardless of the
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/LiquidAI/LFM2.5-1.2B-Base. Regenerate this
