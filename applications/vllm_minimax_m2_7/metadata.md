...
---
id: "ciq/ml_and_ai/vllm_minimax_m2_7"
name: "vLLM MiniMax-M2.7"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`MiniMaxAI/MiniMax-M2.7`](https://recipes.vllm.ai/MiniMaxAI/MiniMax-M2.7) from
...
MiniMax-M2.7](https://recipes.vllm.ai/MiniMaxAI/MiniMax-M2.7): every vLLM flag,
...
MiniMax M2.7 MoE language model (230B total / 10B active) — latest M2 release
for coding, agent toolchains, and long-context reasoning with native FP8

## Model

- **Checkpoint**: `MiniMaxAI/MiniMax-M2.7`
...
| `rtx_pro_6000_2x` | 2x RTX Pro 6000 2x, 192 GB | 2 | verified |
...
| --- | --- | --- | --- |
| `default` | fp8 | 276 GB | `MiniMaxAI/MiniMax-M2.7` |
| `nvfp4` | nvfp4 | 138 GB | `nvidia/MiniMax-M2.7-NVFP4` |
...
```sh
fuzzball workflow catalog start vllm_minimax_m2_7
fuzzball workflow catalog start vllm_minimax_m2_7 --values Hardware=rtx_pro_6000_2x,Strategy=single_node_tp,Variant=nvfp4
fuzzball workflow catalog start vllm_minimax_m2_7 --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `MiniMaxAI/MiniMax-M2.7` regardless of the variant
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/MiniMaxAI/MiniMax-M2.7. Regenerate this application
