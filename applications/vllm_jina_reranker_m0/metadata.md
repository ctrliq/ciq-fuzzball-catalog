...
---
id: "ciq/ml_and_ai/vllm_jina_reranker_m0"
name: "vLLM jina-reranker-m0"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`jinaai/jina-reranker-m0`](https://recipes.vllm.ai/jinaai/jina-reranker-m0)
...
from the [vLLM recipe for Jina Reranker
m0](https://recipes.vllm.ai/jinaai/jina-reranker-m0): every vLLM flag,
...
Multilingual, multimodal reranker for text and visual documents across 29+
languages via Qwen2-VL backbone

## Model

- **Checkpoint**: `jinaai/jina-reranker-m0`
- **Architecture**: dense, 2.4B parameters
- **Active parameters**: 2.4B
- **Context length**: 32768 tokens
- **Minimum vLLM version**: 0.8.0
...
```sh
fuzzball workflow catalog start vllm_jina_reranker_m0
fuzzball workflow catalog start vllm_jina_reranker_m0 --values Hardware=mi355x
fuzzball workflow catalog start vllm_jina_reranker_m0 --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `jinaai/jina-reranker-m0` regardless of the
...
vllm serve jinaai/jina-reranker-m0 \
  ...
  --served-model-name jinaai/jina-reranker-m0
```

Image: `docker://vllm/vllm-openai:v0.8.0`
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/jinaai/jina-reranker-m0. Regenerate this application
