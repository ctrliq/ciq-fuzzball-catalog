...
---
id: "ciq/ml_and_ai/vllm_qwen3_5_9b"
name: "vLLM Qwen3.5-9B"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves [`Qwen/Qwen3.5-9B`](https://recipes.vllm.ai/Qwen/Qwen3.5-9B) from an
...
[vLLM recipe for Qwen3.5-9B](https://recipes.vllm.ai/Qwen/Qwen3.5-9B): every
...
Qwen3.5 dense multimodal model (9B) with gated delta networks hybrid attention,
MTP, and 262K context
...
```sh
fuzzball workflow catalog start vllm_qwen3_5_9b
fuzzball workflow catalog start vllm_qwen3_5_9b --values Hardware=mi355x
fuzzball workflow catalog start vllm_qwen3_5_9b --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `Qwen/Qwen3.5-9B` regardless of the variant
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/Qwen/Qwen3.5-9B. Regenerate this application with
