...
---
id: "ciq/ml_and_ai/vllm_lfm2_5_1_2b_jp_202606"
name: "vLLM LFM2.5-1.2B-JP-202606"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`LiquidAI/LFM2.5-1.2B-JP-202606`](https://recipes.vllm.ai/LiquidAI/LFM2.5-1.2B-JP-202606)
...
from the [vLLM recipe for LFM2.5 1.2B JP
(202606)](https://recipes.vllm.ai/LiquidAI/LFM2.5-1.2B-JP-202606): every vLLM
...
Liquid AI's updated (2026-06) 1.2B Japanese chat model on the LFM2 hybrid
conv+attention backbone — adds tool calling, with a 32K context window.

## Model

- **Checkpoint**: `LiquidAI/LFM2.5-1.2B-JP-202606`
- **Architecture**: dense, 1.2B parameters
- **Active parameters**: 1.2B
...
```sh
fuzzball workflow catalog start vllm_lfm2_5_1_2b_jp_202606
fuzzball workflow catalog start vllm_lfm2_5_1_2b_jp_202606 --values Hardware=mi355x
fuzzball workflow catalog start vllm_lfm2_5_1_2b_jp_202606 --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `LiquidAI/LFM2.5-1.2B-JP-202606` regardless of the
...
vllm serve LiquidAI/LFM2.5-1.2B-JP-202606 \
  ...
  --served-model-name LiquidAI/LFM2.5-1.2B-JP-202606
```
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/LiquidAI/LFM2.5-1.2B-JP-202606. Regenerate this
