...
---
id: "ciq/ml_and_ai/vllm_ling_2_6_1t"
name: "vLLM Ling-2.6-1T"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`inclusionAI/Ling-2.6-1T`](https://recipes.vllm.ai/inclusionAI/Ling-2.6-1T)
...
Ling-2.6-1T](https://recipes.vllm.ai/inclusionAI/Ling-2.6-1T): every vLLM flag,
...
Ling-2.6-1T (BailingMoeV2_5) FP8 instruct model with 1T total / 50B active
params, hybrid linear + MLA attention, 262K context

## Model

- **Checkpoint**: `inclusionAI/Ling-2.6-1T`
...
```sh
fuzzball workflow catalog start vllm_ling_2_6_1t
fuzzball workflow catalog start vllm_ling_2_6_1t --values Hardware=mi355x
fuzzball workflow catalog start vllm_ling_2_6_1t --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `inclusionAI/Ling-2.6-1T` regardless of the
...
vllm serve inclusionAI/Ling-2.6-1T \
  ...
  --served-model-name inclusionAI/Ling-2.6-1T
```
...
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/inclusionAI/Ling-2.6-1T. Regenerate this application
