...
---
id: "ciq/ml_and_ai/vllm_voxtral_mini_4b_realtime_2602"
name: "vLLM Voxtral-Mini-4B-Realtime-2602"
category: "ML_AND_AI"
tags:
- LLM
- inference
...
Serves
[`mistralai/Voxtral-Mini-4B-Realtime-2602`](https://recipes.vllm.ai/mistralai/Voxtral-Mini-4B-Realtime-2602)
...
Voxtral-Mini-4B-Realtime-2602](https://recipes.vllm.ai/mistralai/Voxtral-Mini-4B-Realtime-2602):
...
Multilingual realtime speech transcription (13 languages) with a natively
streaming causal audio encoder; configurable 80ms–2.4s transcription delay
served via vLLM's Realtime API

## Model

- **Checkpoint**: `mistralai/Voxtral-Mini-4B-Realtime-2602`
- **Architecture**: dense, 4.4B parameters
- **Active parameters**: 4.4B
...
```sh
fuzzball workflow catalog start vllm_voxtral_mini_4b_realtime_2602
fuzzball workflow catalog start vllm_voxtral_mini_4b_realtime_2602 --values Hardware=mi355x
fuzzball workflow catalog start vllm_voxtral_mini_4b_realtime_2602 --values ModelVolume=volume://user/models,MaxReplicas=4
```

Clients address the model as `mistralai/Voxtral-Mini-4B-Realtime-2602`
...
-  The recipe lists extra install steps that apply to its pip install path; the
  ...
  -  `uv pip install -U "mistral-common[audio]>=1.9.0"`
  -  `uv pip install -U transformers`
-  Deployment parameters track the recipe at
  https://recipes.vllm.ai/mistralai/Voxtral-Mini-4B-Realtime-2602. Regenerate
